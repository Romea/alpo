...
#ifndef POM_HARDWARE__POM_HARDWARE_HPP_
#define POM_HARDWARE__POM_HARDWARE_HPP_
...
// local
#include "pom_hardware/deadzone_handler.hpp"
...
public:
  RCLCPP_SHARED_PTR_DEFINITIONS(PomHardware);
...
using PomHardware2FWS4WD = PomHardware<HardwareInterface2FWS4WD>;
using PomHardware2FWS2RWD = PomHardware<HardwareInterface2FWS2RWD>;

}  // namespace romea::ros2

#endif  // POM_HARDWARE__POM_HARDWARE_HPP_
