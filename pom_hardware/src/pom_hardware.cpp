...
// local
#include "pom_hardware/pom_hardware.hpp"
#include "pom_hardware/deadzone_dithering.hpp"
#include "pom_hardware/deadzone_gaussian_noise.hpp"
...
//-----------------------------------------------------------------------------
template<typename HardwareInterface>
hardware_interface::return_type PomHardware<HardwareInterface>::connect_()
{
...
//-----------------------------------------------------------------------------
template<typename HardwareInterface>
hardware_interface::return_type PomHardware<HardwareInterface>::disconnect_()
{
...
//-----------------------------------------------------------------------------
template<typename HardwareInterface>
hardware_interface::return_type PomHardware<HardwareInterface>::load_info_(
...
template<typename HardwareInterface>
void PomHardware<HardwareInterface>::load_deadzone_handler_(
  const hardware_interface::HardwareInfo & hardware_info)
{
...
PomHardware<HardwareInterface>::on_init(const hardware_interface::HardwareInfo & hardware_info)
{
  if (
  ...
  if (
    ...
    auto callback = std::bind(
      &PomHardware<HardwareInterface>::joint_states_callback_, this, std::placeholders::_1);
...
//-----------------------------------------------------------------------------
template<typename HardwareInterface>
void PomHardware<HardwareInterface>::send_command_()
{
...
//-----------------------------------------------------------------------------
template<typename HardwareInterface>
void PomHardware<HardwareInterface>::send_null_command_()
{
...
//-----------------------------------------------------------------------------
template<>
void PomHardware<HardwareInterface2FWS4WD>::joint_states_callback_(
...
//-----------------------------------------------------------------------------
template<>
void PomHardware<HardwareInterface2FWS2RWD>::joint_states_callback_(
...
//-----------------------------------------------------------------------------
template<>
void PomHardware<HardwareInterface2FWS2RWD>::set_hardware_state_()
{
...
//-----------------------------------------------------------------------------
template<>
void PomHardware<HardwareInterface2FWS4WD>::set_hardware_state_()
{
...
//-----------------------------------------------------------------------------
template<>
void PomHardware<HardwareInterface2FWS2RWD>::get_hardware_command_()
{
...
//-----------------------------------------------------------------------------
template<>
void PomHardware<HardwareInterface2FWS4WD>::get_hardware_command_()
{
...
//-----------------------------------------------------------------------------
template<typename HardwareInterface>
void PomHardware<HardwareInterface>::open_log_file_()
{
  debug_file_.open(
    std::string("pom.dat").c_str(), std::fstream::in | std::fstream::out | std::fstream::trunc);
}
//-----------------------------------------------------------------------------
template<typename HardwareInterface>
void PomHardware<HardwareInterface>::write_log_header_()
{
...
//-----------------------------------------------------------------------------
template<typename HardwareInterface>
void PomHardware<HardwareInterface>::write_log_data_()
{
  if (debug_file_.is_open()) {
...
template class PomHardware<HardwareInterface2FWS4WD>;
template class PomHardware<HardwareInterface2FWS2RWD>;

}  // namespace ros2
}  // namespace romea

#include "pluginlib/class_list_macros.hpp"
PLUGINLIB_EXPORT_CLASS(romea::ros2::PomHardware2FWS4WD, hardware_interface::SystemInterface)
PLUGINLIB_EXPORT_CLASS(romea::ros2::PomHardware2FWS2RWD, hardware_interface::SystemInterface)
