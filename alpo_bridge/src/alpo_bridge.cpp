...
const char bridge_joy_topic[] = "/alpo_bridge/joy";
const char bridge_odom_topic[] = "/alpo_bridge/vehicle_controller/odom";
const char bridge_cmd_steer_topic[] = "/alpo_bridge/vehicle_controller/cmd_steer";
const char bridge_joint_states_topic[] = "/alpo_bridge/vehicle_controller/joint_states";
